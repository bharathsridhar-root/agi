      ...
      <div className="mb-3 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-ink-muted">
            {activeCount} of 5 on. Changing one starts the run over.
          </p>
        </div>
        <div className="flex gap-1.5">
          <button
            ...
            className="rounded border border-line-strong px-2 py-1 font-mono text-2xs uppercase tracking-[0.1em] text-ink-secondary transition-colors hover:bg-ink-primary/5 hover:text-ink-primary disabled:opacity-35"
          >
            None
          </button>
          <button
              ...
              <button
                ...
                className={`group flex w-full items-start gap-3 rounded-md border p-2.5 text-left transition-colors ${
                  on
                    ...
                    : 'border-line bg-ink-primary/[0.015] hover:border-line-strong hover:bg-ink-primary/[0.04]'
                }`}
              >
                <span
